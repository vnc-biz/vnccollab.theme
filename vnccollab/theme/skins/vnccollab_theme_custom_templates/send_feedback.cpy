...
sender_id = u"%s (%s), %s" % (safe_unicode(sender.getProperty('fullname')),
    safe_unicode(sender.getId()), safe_unicode(send_from_address))
...
variables = {'send_from_address' : safe_unicode(send_from_address),
             'sender_id'         : sender_id,
             'url'               : safe_unicode(referer),
